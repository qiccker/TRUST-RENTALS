...
function BookingCancelPage() {
  return <section className="bg-mist py-16">
      <div className="mx-auto max-w-xl rounded-md border border-line bg-white p-8 text-center shadow-sm">
        ...
        <h1 className="mt-4 text-3xl font-black text-ink">Payment not completed</h1>
        <p className="mt-3 text-sm leading-6 text-graphite">
          No payment was captured. Your pending booking hold will expire automatically within 30 minutes.
        </p>
